      ...
      >
        ...
        <View style={styles.cardBody}>
          ...
          {/* <View style={styles.locationContainer}>
            ...
            <Text style={[styles.subtitle, isDark ? {color: "#aaa"} : {color: "#666"}]} numberOfLines={1}>
              {item.category}
            </Text>
          </View> */}
        </View>
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate("SearchClothPost")}
        >
      ...
      {loading ? (
        ...
        <FlatList
          ...
          snapToInterval={266} // card width (250) + margin (16)
