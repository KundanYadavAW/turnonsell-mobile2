...
const BookPostDetails = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch Post Details
      const postResponse = await axios.get(`${baseURL}/api/post/${id}`);
  ...
  const handleSendNumber = async () => {
    ...
    try {
      await axios.post(`${baseURL}/api/sendPhoneNumber`, {
        postId: post.id,
        phoneNumber,
      });
  ...
  const handleWhatsAppContact = () => {
    if (post && post.phone_number) {
      const whatsappUrl = `whatsapp://send?phone=${post.phone_number}&text=Hi, I'm interested in your ${post.book_name || post.cloth_name} listing.`;
  ...
  if (loading) {
    return (
      <View style={[styles.centerContainer, isDark ? styles.darkBg : styles.lightBg]}>
        ...
        <Text style={[styles.loadingText, isDark ? styles.darkText : styles.lightText]}>Loading post details...</Text>
      </View>
    );
  }
        ...
        <View style={styles.contentPadding}>
          ...
          <View style={styles.titleSection}>
            <Text style={[styles.mainTitle, isDark ? styles.darkTitle : styles.lightTitle]}>
              {post.book_name || post.cloth_name}
            </Text>
