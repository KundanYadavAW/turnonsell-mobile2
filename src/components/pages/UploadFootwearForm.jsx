...
//     try {
//       const response = await axios.get(`${baseURL}/dropdown/footwearCategories/${selectedGenderId}`);
...
//     try {
//       const response = await axios.get(`${baseURL}/dropdown/footwearSubcategories/${selectedCategoryId}`);
...
//     if (!collegeId || !genderId || !categoryId || !subcategoryId || !description || !price || !size || rating === 0 || images.length === 0) {
...
//     formData.append("footwearCategoryId", categoryId);
//     formData.append("footwearSubcategoryId", subcategoryId);
...
//     try {
//       const response = await axios.post(`${baseURL}/footwear/footwearpostCreate`, formData, {
//         headers: {
...
//       Alert.alert("Success", response.data.message || "Footwear listed successfully!");
//       navigation.goBack(); 
//     } catch (error) {
...
//             <Text style={[styles.sectionTitle, { marginTop: 16 }]}>Footwear Information</Text>
...
//                 <Text style={[styles.label, isDark ? styles.darkText : styles.lightText]}>Size *</Text>
//                 <TextInput
//                     style={[styles.input, isDark ? styles.darkInput : styles.lightInput]}
//                     placeholder="Size eg. UK10, US9"
...
//                     placeholder="Describe the item condition, brand, style, etc."
//                     placeholderTextColor={isDark ? "#aaa" : "#888"}
//                     value={description}
...
// export default UploadFootwearForm;
...
const UploadFootwearForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append("footwearCategoryId", String(categoryId));
      formData.append("footwearSubcategoryId", String(subcategoryId));
      formData.append("description", description);
      ...
      const response = await axiosInstance.post(`${baseURL}/footwear/footwearpostCreate`, formData, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "multipart/form-data",
