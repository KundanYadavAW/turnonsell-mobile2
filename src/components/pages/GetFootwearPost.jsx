...
const GetFootwearPost = () => {
  ...
  const fetchPosts = async () => {
    try {
      ...
      // Shuffle posts
      const shuffled = parsedData.sort(() => 0.5 - Math.random()).slice(0, 100);
      setPosts(shuffled);
    } catch (err) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate("SearchFootwearPost")}
        >
...
export default GetFootwearPost;
