    ...
    return (
      ...
      >
        ...
        <View style={styles.cardBody}>
          <Text style={[styles.bookName, isDark ? styles.darkText : styles.lightText]} numberOfLines={1}>
            {item.book_name}
          </Text>
          <View style={styles.locationContainer}>
            <Ionicons name="location-outline" size={14} color={isDark ? "#aaa" : "#666"} />
            <Text style={[styles.collegeName, isDark ? {color: "#aaa"} : {color: "#666"}]} numberOfLines={1}>
